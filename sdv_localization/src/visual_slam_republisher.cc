...
class vslam_repub : public rclcpp::Node
{
  

public:
  vslam_repub() : Node("vslam_repub_node")
  {
    //Parameter
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<vslam_repub>());
  rclcpp::shutdown();
  return 0;
}